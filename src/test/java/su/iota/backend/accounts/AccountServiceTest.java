...
public class AccountServiceTest {
    ...
    private UserProfile userProfile = new UserProfile(login, email, password);
    private long userId;
    ...
    public void tearDown() throws Exception{
        ...
        if (accountService.isUserExistent(login2)) {
            final Long id = accountService.getUserId(login2);
            if (id == null) {
                return;
            }
